...
{% include teaser.html title="Become a Booster" img="/img/thumbnails/social-boost-thumbnail.png"  text="Learn how to make money from social media by joining Social Boost." url="/boost" buttontext="Learn more" url="/boost" %}
